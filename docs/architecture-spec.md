...
| 29 Nov 2026 | Checkpoint: both EMs, host SPI, monitors, recorder and Ear integrated; UART, SPI and I2C pass protocol tests and their contracts are proven; cell count under 13,000 or the cut list applies | Both | Contracts proven: UART TX (any number of frames), UART RX, SPI master; I2C pending |
